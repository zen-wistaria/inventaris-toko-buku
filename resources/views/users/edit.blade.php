        ...
        <div class="p-4 w-full max-h-full">
            <div class="bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('users.update', $user->username) }}" method="post">
                        @method('PATCH')
                        @csrf
                        <div>
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="address" id="address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" value="{{ $user->address }}" required />
                            </div>
                            <div>
                                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                                <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Kosongkan jika tidak ingin mengganti password.." />
                            </div>
                            <div>
                                ...
                                <select name="role" id="role" class="w-full rounded-md block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    ...
                                    <option value="1" {{ $user->role == 1 ? 'selected' : '' }}>Pengelola</option>
