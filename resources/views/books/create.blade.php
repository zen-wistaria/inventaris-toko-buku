        ...
        <div class="p-4 w-full max-h-full">
            <div class="bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('books.store') }}" method="post" id="formbook">
                        @csrf
                        <div>
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="year" id="year" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                            </div>
                            <div>
